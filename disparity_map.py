...
INPUTARRAYMTX_left, INPUTARRAYDISTCOEFFS_left, SIZE_L, objpoints_l, imgpoints_l, focal_length_left = calculate_error("left.png", "left2.png", "calibrated_left.png")
INPUTARRAYMTX_right, INPUTARRAYDISTCOEFFS_right, SIZE_R,objpoints_r, imgpoints_r, focal_length_right = calculate_error("right.png", "right2.png", "calibrated_right.png")
...
stereoMatcher = cv2.StereoBM_create(96,15)

stereoMatcher.setMinDisparity(-20)
